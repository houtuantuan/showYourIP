  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <div className='dark:bg-gray-500'>
        ...
        <h1 className='text-2xl text-center font-serif p-3 dark:text-gray-100	'>
          General Infomation
        </h1>
      ...
      <div className="bg-slate-100 grid grid-cols-5	"> */}
            ...
            <p className='col-start-2 dark:text-gray-100	'>
        ...
        <div>
          <h1 className='text-2xl text-center font-serif p-3 mt-5 dark:text-gray-100	'>
            {' '}
            Your Location
          </h1>

          <Map lat={coordination.latitude} lng={coordination.longitude} />
        </div>
        <footer className=' text-center h-40'>
          <p className='dark:text-gray-100	'>
            Contact me:xiaoyan.hou@hotmail.com
          </p>
          <div className='flex justify-center'>
            <a href='https://github.com/houtuantuan' target='_blank'>
              
              <BsGithub className='mx-2' />
            </a>
            <a
              href='https://www.linkedin.com/in/xiaoyanhouwebdeveloper/'
              target='_blank'
            >
